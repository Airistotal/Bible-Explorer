...
namespace BE_webapp.Models
{
    ...
    public partial class bibex_dbEntities : DbContext
    {
        ...
        public virtual ObjectResult<BibleVerse> usp_GetChapter(Nullable<int> bibleID, Nullable<int> book, Nullable<int> chapter)
        {
            var bibleIDParameter = bibleID.HasValue ?
                new ObjectParameter("bibleID", bibleID) :
                new ObjectParameter("bibleID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<BibleVerse>("usp_GetChapter", bibleIDParameter, bookParameter, chapterParameter);
        }
