namespace BB.API.Controllers
{
    ...
    public class BibleMetaController : ControllerBase
    {
        ...
        // get: api/BibleMeta/GetNumberOfChaptersForBookInBible?bible=1&book=1
        [Route("GetNumberOfChaptersForBookInBible")]
        public int GetNumberOfChaptersForBookInBible([FromQuery]BibleID bible, [FromQuery]int book)
        {
